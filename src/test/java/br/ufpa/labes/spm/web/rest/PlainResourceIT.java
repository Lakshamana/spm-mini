...
public class PlainResourceIT {
  ...
  @Autowired private PlainRepository plainRepository;
  ...
  public void setup() {
    ...
    this.restPlainMockMvc =
        MockMvcBuilders.standaloneSetup(plainResource)
  ...
  public static Plain createEntity(EntityManager em) {
    Plain plain = new Plain().requirements(DEFAULT_REQUIREMENTS);
    return plain;
  }
  /**
  ...
  public static Plain createUpdatedEntity(EntityManager em) {
    Plain plain = new Plain().requirements(UPDATED_REQUIREMENTS);
    return plain;
  }
  ...
  public void getAllPlains() throws Exception {
    ...
    restPlainMockMvc
        .perform(get("/api/plains?sort=id,desc"))
  ...
  public void getPlain() throws Exception {
    ...
    // Get the plain
    restPlainMockMvc
        .perform(get("/api/plains/{id}", plain.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingPlain() throws Exception {
    // Get the plain
    restPlainMockMvc
        .perform(get("/api/plains/{id}", Long.MAX_VALUE))
  ...
  public void updatePlain() throws Exception {
    ...
    updatedPlain.requirements(UPDATED_REQUIREMENTS);
  ...
  public void deletePlain() throws Exception {
    ...
    // Delete the plain
    restPlainMockMvc
        .perform(delete("/api/plains/{id}", plain.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
