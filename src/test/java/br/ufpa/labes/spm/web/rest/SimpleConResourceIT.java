...
public class SimpleConResourceIT {
  ...
  @Autowired private SimpleConRepository simpleConRepository;
  ...
  public void setup() {
    ...
    this.restSimpleConMockMvc =
        MockMvcBuilders.standaloneSetup(simpleConResource)
  ...
  public void getAllSimpleCons() throws Exception {
    ...
    restSimpleConMockMvc
        .perform(get("/api/simple-cons?sort=id,desc"))
  ...
  public void getSimpleCon() throws Exception {
    ...
    // Get the simpleCon
    restSimpleConMockMvc
        .perform(get("/api/simple-cons/{id}", simpleCon.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingSimpleCon() throws Exception {
    // Get the simpleCon
    restSimpleConMockMvc
        .perform(get("/api/simple-cons/{id}", Long.MAX_VALUE))
  ...
  public void deleteSimpleCon() throws Exception {
    ...
    restSimpleConMockMvc
        .perform(
            delete("/api/simple-cons/{id}", simpleCon.getId())
