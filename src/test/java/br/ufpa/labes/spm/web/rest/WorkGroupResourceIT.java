...
public class WorkGroupResourceIT {
  ...
  @Autowired private WorkGroupRepository workGroupRepository;
  ...
  public void setup() {
    ...
    this.restWorkGroupMockMvc =
        MockMvcBuilders.standaloneSetup(workGroupResource)
  ...
  public void getAllWorkGroups() throws Exception {
    ...
    restWorkGroupMockMvc
        .perform(get("/api/work-groups?sort=id,desc"))
  ...
  public void getWorkGroup() throws Exception {
    ...
    // Get the workGroup
    restWorkGroupMockMvc
        .perform(get("/api/work-groups/{id}", workGroup.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingWorkGroup() throws Exception {
    // Get the workGroup
    restWorkGroupMockMvc
        .perform(get("/api/work-groups/{id}", Long.MAX_VALUE))
  ...
  public void deleteWorkGroup() throws Exception {
    ...
    restWorkGroupMockMvc
        .perform(
            delete("/api/work-groups/{id}", workGroup.getId())
