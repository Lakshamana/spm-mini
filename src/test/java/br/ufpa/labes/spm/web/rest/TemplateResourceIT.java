...
public class TemplateResourceIT {
  ...
  public void setup() {
    ...
    this.restTemplateMockMvc =
        MockMvcBuilders.standaloneSetup(templateResource)
  ...
  public static Template createEntity(EntityManager em) {
    Template template = new Template().templateState(DEFAULT_TEMPLATE_STATE);
    return template;
  }
  /**
  ...
  public static Template createUpdatedEntity(EntityManager em) {
    Template template = new Template().templateState(UPDATED_TEMPLATE_STATE);
    return template;
  }
  ...
  public void getAllTemplates() throws Exception {
    ...
    restTemplateMockMvc
        ...
        .andExpect(jsonPath("$.[*].templateState").value(hasItem(DEFAULT_TEMPLATE_STATE)));
  }
  ...
  public void getTemplate() throws Exception {
    ...
    restTemplateMockMvc
        ...
        .andExpect(jsonPath("$.templateState").value(DEFAULT_TEMPLATE_STATE));
  }
  ...
  public void getNonExistingTemplate() throws Exception {
    // Get the template
    restTemplateMockMvc
        .perform(get("/api/templates/{id}", Long.MAX_VALUE))
  ...
  public void updateTemplate() throws Exception {
    ...
    updatedTemplate.templateState(UPDATED_TEMPLATE_STATE);
  ...
  public void deleteTemplate() throws Exception {
    ...
    restTemplateMockMvc
        .perform(
            delete("/api/templates/{id}", template.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
