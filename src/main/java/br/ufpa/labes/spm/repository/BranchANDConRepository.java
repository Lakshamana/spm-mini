...
@Repository
public interface BranchANDConRepository extends GenericRepository<BranchANDCon, Long> {

  @Query(
      value =
          "select distinct branchANDCon from BranchANDCon branchANDCon left join fetch branchANDCon.toMultipleCons",
