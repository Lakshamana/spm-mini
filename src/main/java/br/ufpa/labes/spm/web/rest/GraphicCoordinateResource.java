...
public class GraphicCoordinateResource {
   ...
   *     graphicCoordinate, or with status {@code 400 (Bad Request)} if the graphicCoordinate has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/graphic-coordinates")
  public ResponseEntity<GraphicCoordinate> createGraphicCoordinate(
      @RequestBody GraphicCoordinate graphicCoordinate) throws URISyntaxException {
   ...
   *     graphicCoordinate, or with status {@code 400 (Bad Request)} if the graphicCoordinate is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the graphicCoordinate couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/graphic-coordinates")
  public ResponseEntity<GraphicCoordinate> updateGraphicCoordinate(
      @RequestBody GraphicCoordinate graphicCoordinate) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, graphicCoordinate.getId().toString()))
        .body(result);
  }
  ...
  public List<GraphicCoordinate> getAllGraphicCoordinates(
   ...
   *     graphicCoordinate, or with status {@code 404 (Not Found)}.
   */
