...
public class WebAPSEEObjectResource {
   ...
   *     webAPSEEObject, or with status {@code 400 (Bad Request)} if the webAPSEEObject has already
   *     an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/web-apsee-objects")
  public ResponseEntity<WebAPSEEObject> createWebAPSEEObject(
      @Valid @RequestBody WebAPSEEObject webAPSEEObject) throws URISyntaxException {
    log.debug("REST request to save WebAPSEEObject : {}", webAPSEEObject);
    if (webAPSEEObject.getId() != null) {
      throw new BadRequestAlertException(
          "A new webAPSEEObject cannot already have an ID", ENTITY_NAME, "idexists");
    }
   ...
   *     webAPSEEObject, or with status {@code 400 (Bad Request)} if the webAPSEEObject is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the webAPSEEObject couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/web-apsee-objects")
  public ResponseEntity<WebAPSEEObject> updateWebAPSEEObject(
      @Valid @RequestBody WebAPSEEObject webAPSEEObject) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, webAPSEEObject.getId().toString()))
        .body(result);
  }
   ...
   *
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of webAPSEEObjects
   *     in body.
   */
   ...
   *     webAPSEEObject, or with status {@code 404 (Not Found)}.
   */
