...
public class InvolvedArtifactResource {
   ...
   *     involvedArtifact, or with status {@code 400 (Bad Request)} if the involvedArtifact has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/involved-artifacts")
  public ResponseEntity<InvolvedArtifact> createInvolvedArtifact(
      @RequestBody InvolvedArtifact involvedArtifact) throws URISyntaxException {
   ...
   *     involvedArtifact, or with status {@code 400 (Bad Request)} if the involvedArtifact is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the involvedArtifact couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/involved-artifacts")
  public ResponseEntity<InvolvedArtifact> updateInvolvedArtifact(
      @RequestBody InvolvedArtifact involvedArtifact) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, involvedArtifact.getId().toString()))
        .body(result);
  }
   ...
   *     involvedArtifact, or with status {@code 404 (Not Found)}.
   */
