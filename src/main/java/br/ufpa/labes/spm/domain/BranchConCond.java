...
public class BranchConCond extends BranchCon implements Serializable {
  ...
  public BranchConCond theBranchConCondToActivities(
      Set<BranchConCondToActivity> branchConCondToActivities) {
    this.theBranchConCondToActivities = branchConCondToActivities;
    return this;
  }

  public BranchConCond addTheBranchConCondToActivity(
      BranchConCondToActivity branchConCondToActivity) {
    this.theBranchConCondToActivities.add(branchConCondToActivity);
    branchConCondToActivity.setTheBranchConCond(this);
    return this;
  }

  public BranchConCond removeTheBranchConCondToActivity(
      BranchConCondToActivity branchConCondToActivity) {
  ...
  public void setTheBranchConCondToActivities(
      Set<BranchConCondToActivity> branchConCondToActivities) {
    this.theBranchConCondToActivities = branchConCondToActivities;
  }
  ...
  public BranchConCond theBranchConCondToMultipleCons(
      Set<BranchConCondToMultipleCon> branchConCondToMultipleCons) {
    this.theBranchConCondToMultipleCons = branchConCondToMultipleCons;
    return this;
  }

  public BranchConCond addTheBranchConCondToMultipleCon(
  ...
  public BranchConCond removeTheBranchConCondToMultipleCon(
      BranchConCondToMultipleCon branchConCondToMultipleCon) {
  ...
  public void setTheBranchConCondToMultipleCons(
      Set<BranchConCondToMultipleCon> branchConCondToMultipleCons) {
    this.theBranchConCondToMultipleCons = branchConCondToMultipleCons;
  }
  ...
  public String toString() {
    return "BranchConCond{" + "id=" + getId() + ", kindBranch='" + getKindBranch() + "'" + "}";
  }
}
